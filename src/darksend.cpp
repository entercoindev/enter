...
{
    if(fLiteMode) return; // ignore all Enter related functionality
...
/*
    ...
    allow endless transaction that would bloat Enter and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("enter-privatesend");
