...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EnterNetwork") type = EnterNetwork;
    if(strType == "EnterNetworkVariable") type = EnterNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EnterNetwork) s = "EnterNetwork";
    if(type == EnterNetworkVariable) s = "EnterNetworkVariable";
