 ...
 *
 *   // network
 *   CEnterNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.enter.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEnterNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: EnterNetwork
// //   -- signature requirements : Key1(User)
// class CEnterNetworkVariable : public CGovernanceObject
// {
// private:
