    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ENTER-light"), QVariant("light"));
    ui->theme->addItem(QString("ENTER-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ENTER-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ENTER-traditional"), QVariant("trad"));
