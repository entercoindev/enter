    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Enter Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Enter address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and enter: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Enter Core"), this);
    aboutAction->setStatusTip(tr("Show information about Enter Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Enter Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Enter addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Enter addresses"));
    ...
    openAction->setStatusTip(tr("Open a enter: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Enter Core help message to get a list with possible Enter Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Enter Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Enter network", "", count));
}
...
{
    QString strTitle = tr("Enter Core"); // default title
