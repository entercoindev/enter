    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Enter Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Enter Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  enter-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Enter in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ENTER, 0.1 ENTER, 1 ENTER and 10 ENTER -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://enterpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://enterpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Enter Core is shutting down...") + "<br /><br />" +
