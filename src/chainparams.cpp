...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("enter.org", "dnsseed.enter.org"));
        vSeeds.push_back(CDNSSeedData("enterdot.io", "dnsseed.enterdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("enterpay.io", "dnsseed.enterpay.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("enterdot.io",  "testnet-seed.enterdot.io"));
