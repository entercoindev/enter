...
This mechanism has been integrated into Bitcore-Node-Enter which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/entercoindev/insight-api-enter#web-socket-api](https://github.com/entercoindev/insight-api-enter#web-socket-api) 
* API: [https://github.com/entercoindev/insight-api-enter#instantsend-transactions](https://github.com/entercoindev/insight-api-enter#instantsend-transactions) 
...
By default, the Enter Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Enter Core daemon:
