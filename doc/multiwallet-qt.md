...
Only requiring some minor changes is enter.cpp.
...
Changes to enter.cpp
----------------------
enter.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
